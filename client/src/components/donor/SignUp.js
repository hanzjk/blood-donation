                    ...
                    <div className="row">
                        ...
                        <div className="col md-6">
                            <div className="form-group" style={{ marginBottom: "15px" }}>
                                ...
                                <input required="true" type="text" className="form-control" name="nic" placeholder="Enter the nic number" value={this.state.nic} onChange={this.handleInputChange}></input>
                            </div>
                        </div>
                    </div>
