...
export default class Login extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post("http://localhost:8000/donor/login", data).then((res) => {
            if (res.data.success) {
                this.setState({
                    userName: "",
                    password: "",
                ...
                this.props.history.push(`/donor/password/update/${res.data.message._id}`);
            }
            else {
        ...
        return (
            <div className="container">
                <div className="col-md-8 mt-4 mx-auto">
                    <h1 className="h3 mb-3 font-weight-normal">Donor Login</h1>
