...
export default class ChangePhoto extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.put(`http://localhost:8000/donor/photo/update/${id}`, formData).then((res) => {
            if (res.data.success) {
                this.setState({
                    img: "",
                    error: ""
                ...
                <div className="container">
                    <div className="col-md-8 mt-4 mx-auto">
                        ...
                        <div className="d-flex flex-column align-items-center text-center">
                            <img src={`/../uploads/donor/${this.state.donor.img}`} alt="photo" style={{ width: "15%", height: "15%", marginLeft: "auto", marginRight: "auto" }}></img>
                        </div>
                        <form className="needs-validation" noValidate>
                            <div className="form-group" style={{ marginBottom: "15px" }}>
                                <label style={{ marginBottom: '5px' }}>Change Profile Photo (Rename with donor id)</label>
